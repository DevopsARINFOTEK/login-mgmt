...
export default function Login() {
  ...
  const loginUser = async (e) => {
    ...
    try {
      const response = axios.post("http://localhost:5000/login", loginData, role); 
...
>
    ...
    <option value="INTERN">Intern</option>
          ...
          <footer className="bg-blue-900 text-slate-200 py-12">
  <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
    ...
    <div>
      ...
      <ul className="space-y-2 text-sm">
        <li><a href="#courses" className="hover:text-white">AWS Architect</a></li>
        <li><a href="#courses" className="hover:text-white">Data Science</a></li>
        <li><a href="#courses" className="hover:text-white">DevOps</a></li>
      </ul>
    </div>
